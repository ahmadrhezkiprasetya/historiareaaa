...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Historia Nusantara — Babad Para Pahlawan" },
      { name: "twitter:title", content: "Historia Nusantara — Babad Para Pahlawan" },
      { property: "og:description", content: "Museum digital editorial: Pangeran Diponegoro, Tuanku Imam Bonjol, dan kisah perlawanan Nusantara." },
      { name: "twitter:description", content: "Museum digital editorial: Pangeran Diponegoro, Tuanku Imam Bonjol, dan kisah perlawanan Nusantara." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/718aac39-545e-46ce-a2e7-ad60b0a05e9a/id-preview-4931ab2f--28228cc0-6aae-4e36-8b45-2a089c9fc4ab.lovable.app-1778421217479.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/718aac39-545e-46ce-a2e7-ad60b0a05e9a/id-preview-4931ab2f--28228cc0-6aae-4e36-8b45-2a089c9fc4ab.lovable.app-1778421217479.png" },
